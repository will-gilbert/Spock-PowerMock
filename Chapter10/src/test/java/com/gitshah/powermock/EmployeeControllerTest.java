...
public class EmployeeControllerTest {
    ...
    public void shouldFindEmployeeByEmailUsingTheAnswerInterface() {
        ...
        //Depending on what argument is passed we could either return a valid employee
        //or return null.
        PowerMockito
                .when(mock.findEmployeeByEmail(Mockito.anyString()))
                .then(new Answer<Employee>() {
                    /**
                     * Implementing the answer method to return a valid employee,
                     * if email starts with "deep" or ends with "packtpub.com"
